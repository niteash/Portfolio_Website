  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="w-11 h-11 rounded-lg grid place-items-center bg-zinc-400 text-zinc-300 shrink-0">
          <span aria-hidden="true" className="">
            <LaunchSharpIcon className="text-neutral-950"/>
          </span>
        </div>
      </div>

      <a className="absolute inset-0" href={projectLink} target="_blank"></a>
    </div>
  );
};
